...
//		BufferedReader br = new BufferedReader(new FileReader("D://sample_input.txt"));
		BufferedReader br = new BufferedReader(new FileReader("/Users/bongkeunshin/Downloads/sample_input6.txt"));
...
//					}
					if (CCW(ix1, iy1, ix2, iy2, jx1, jy1) * CCW(ix1, iy1, ix2, iy2, jx2, jy2) == 0
							&& CCW(jx1, jy1, jx2, jy2, ix1, iy1) * CCW(jx1, jy1, jx2, jy2, ix2, iy2) == 0) {
//						if(show) {
//						System.out.println(CCW(ix1, iy1, ix2, iy2, jx1, jy1) +" , "+CCW(ix1, iy1, ix2, iy2, jx2, jy2)
//							 +" , "+ CCW(jx1, jy1, jx2, jy2, ix1, iy1)  +" , "+CCW(jx1, jy1, jx2, jy2, ix2, iy2));
//						}
						boolean fight = false;
						System.out.println("들어왔니");
						double d1 = Math.sqrt(Math.pow(ix1 - jx1, 2) + Math.pow(iy1 - jy1, 2));
						double d2 = Math.sqrt(Math.pow(ix2 - jx1, 2) + Math.pow(iy2 - jy1, 2));
						double d3 = Math.sqrt(Math.pow(jx2 - jx1, 2) + Math.pow(jy2 - jy1, 2));
						System.out.println(d1+" "+ d2+" "+d3);
						
						double d4 = Math.sqrt(Math.pow(jx1 - ix1, 2) + Math.pow(jy1 - iy1, 2));
						double d5 = Math.sqrt(Math.pow(jx2 - ix1, 2) + Math.pow(jy2 - iy1, 2));
						double d6 = Math.sqrt(Math.pow(ix2 - ix1, 2) + Math.pow(iy2 - iy1, 2));
						System.out.println(d4+" "+ d5+" "+d6);
						
						if((d1 <= d2 && d3 >=d1|| d1>d2 && d3 >= d2) 
								 && (d4 <= d5 && d6 >=d4|| d4>d5 && d6 >= d5)) {
							fight = true;
						}
//						if( iy2 - iy1 == 0) {
